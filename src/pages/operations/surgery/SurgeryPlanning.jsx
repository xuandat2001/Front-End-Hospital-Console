...
const STATUS_STYLES = {
  SCHEDULED: "border-l-yellow-400 bg-yellow-50 text-yellow-800 dark:bg-yellow-900/20 dark:text-yellow-200",
  IN_PROGRESS: "border-l-blue-400 bg-blue-50 text-blue-800 dark:bg-blue-900/20 dark:text-blue-200",
  COMPLETED: "border-l-green-400 bg-green-50 text-green-800 dark:bg-green-900/20 dark:text-green-200",
  CANCELLED: "border-l-red-400 bg-red-50 text-red-800 dark:bg-red-900/20 dark:text-red-200",
};
...
export default function SurgeryPlanning() {
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      {subView === "calendar" ? <SurgeryCalendar /> : <SurgeryAdmissionLinker />}
    </div>
  );
}
          ...
          {selectedSurgery ? (
            <div className="rounded-xl border border-slate-200 bg-white p-5 dark:border-slate-800 dark:bg-slate-900">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div><span className="text-xs font-semibold uppercase tracking-wide text-slate-400">Scheduled Date</span><p className="font-medium text-slate-900 dark:text-white">{selectedSurgery.scheduledDate ? new Date(selectedSurgery.scheduledDate).toLocaleDateString() : "-"}</p></div>
